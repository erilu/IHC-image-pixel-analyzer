...
# calculate "confinement" (how much do stain a and b mix?). 
# Designed to read in files with block size 25x25 and generate data using threshold value 1-99%.
# The stains I quantifying here are: IgD (stain a) and GL7 (stain b)

#Read the batch files in:
########################################################################
batch_dir = "/Users/ericklu/Desktop/Bioinformatics/ihc_quant/matlab_pictures"
########################################################################
setwd(batch_dir)
...
########################################################################
output_dir = "/Users/ericklu/Desktop/Bioinformatics/ihc_quant/R_output"
########################################################################
